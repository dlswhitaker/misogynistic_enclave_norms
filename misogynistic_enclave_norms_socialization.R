######Misogynistic Enclave Norms Model: Socialization######
###Purpose: 
#Simulate the formation of "misogynistic enclaves",concentrated groups of sexual harassment perpetrators,
#and change in group norms based on agents changing their behavior in order to minimize cost of intervention or harassment.

#Thompson sampling will be used to determine how agents change behavior.
...
#number of opportunities to conform 
rounds <- 100
...
qplot(initialgroups,initialh,fill=as.factor(initialgroups),data=agents,geom="blank",xlab = "Group", ylab = "Propensity to Harass")+geom_violin()+theme_classic()+ylim(0,1)
